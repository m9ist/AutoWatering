...
Не закрыто: заливка MQTT-прошивки на ESP и живые проверки на железе
(#13/#16/#17), e2e команд из чата (#15), ACL брокера (#19), имена растений
в PLANT_NAMES (стек watering).
